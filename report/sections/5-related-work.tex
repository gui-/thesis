...
To conclude, in the surveyed systems the common representation of code is textual. This format is accurate and suitable for storing in a file, perhaps for publishing in a book, because it is static, however, to be understood it requires the reader to know the vocabulary of the programming language. For a novice it is simply a barrier to learning. On the other hand, the representation of programs as a graphical components or mathematical forms eliminate this barrier, but it becomes incomprehensible as the program grows. 